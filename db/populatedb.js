            ...
            batch.map(async (p) => {
                for (let attempt = 1; attempt <= 3; attempt++) {
                    try {
                        ...
                        const displayName = species.names.find(n => n.language.name === "en")?.name ?? poke.name;
...
async function populatedb(client) {
    ...
    const trainerSprites = [
        ...
        {
            name: "DPPt Galactic Grunt F",
            sprite: "Spr_DP_Galactic_Grunt_F.png",
        },
        {
            name: "DPPt Galactic Grunt M",
            sprite: "Spr_DP_Galactic_Grunt_M.png",
        },
        ...
        {
            name: "DPPt Pokémon Breeder F",
            sprite: "Spr_DP_Pokémon_Breeder_F.png",
        },
        {
            name: "DPPt Pokémon Breeder M",
            sprite: "Spr_DP_Pokémon_Breeder_M.png",
        },
        {
            name: "DPPt Pokémon Ranger F",
            sprite: "Spr_DP_Pokémon_Ranger_F.png",
        },
        {
            name: "DPPt Pokémon Ranger M",
            sprite: "Spr_DP_Pokémon_Ranger_M.png",
        },
